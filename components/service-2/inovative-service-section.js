				...
				<div className="row">
					<div className="col-xxl-6 col-xl-6 col-lg-6 offset-xxl-1 order-lg-2">
						<div className="fugu-innovative-services-thumb wow fadeInUpX">
							<img style={{borderRadius:"20px"}} src="/images/all-img/service/crypto24.png" alt="" />
						</div>
					</div>
					<div className="col-xxl-5 col-xl-6 col-lg-6 col-md-10 d-flex align-items-center">
						<div className="fugu-default-content">
							<h2 style={{color:"white"}}>We provide all kinds of innovative services as per your needs</h2>
							<p style={{color:"white"}}>
							Crypto payment gateways provide secure and efficient solutions for accepting digital payments, which are essential for businesses looking to expand their customer base by accepting cryptocurrencies							</p>
							<p style={{color:"white"}}>

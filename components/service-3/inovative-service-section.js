				...
				<div className="row">
					<div className="col-xxl-6 col-xl-6 col-lg-6 offset-xxl-1 order-lg-2">
						<div className="fugu-innovative-services-thumb wow fadeInUpX">
							<img style={{borderRadius:"20px"}} src="/images/all-img/service/crypto25.png" alt="" />
						</div>
					</div>
					<div className="col-xxl-5 col-xl-6 col-lg-6 col-md-10 d-flex align-items-center">
						<div className="fugu-default-content">
							...
							<p style={{color:"white"}}>
							White-label crypto card services allow businesses to provide their customers with branded debit cards that enable them to seamlessly spend their cryptocurrency.							</p>
							<p style={{color:"white"}}>

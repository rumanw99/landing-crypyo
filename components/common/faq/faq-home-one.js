				...
				<div className="row">
					<div className="col-lg-5 position-relative">
						<div className="fugu-default-content large-content">
							...
							<p>
								Frequently asked questions about our NFT currency app. The NFT security for
					...
					<div className="col-lg-5 offset-lg-2">
						<div className="fugu-accordion-wrap">
							<div className="fugu-accordion-item">
								<h4>Is it safe to use NFT app?</h4>
								<p>
									Yes, B2B Ultimate NFT app and Coinbase are safe and use security measures that are
									industry-standard or above for U.S.-based.
								</p>
							</div>
							<div className="fugu-accordion-item">
								<h4>How do I connect B2B Ultimate to my NFT wallet?</h4>
								<p>
							...
							<div className="fugu-accordion-item">
								<h4>How do you make money with NFT app?</h4>
								<p>
									This is the most common way of earning money from NFT currencies. Investors buy
